...
class Asset(Base):
    ...
    category_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("asset_categories.id"), nullable=False)
    ...
    assigned_to_id: Mapped[uuid.UUID | None] = mapped_column(GUID(), ForeignKey("users.id"), nullable=True)
